...
inline std::istream &operator>>(std::istream &in, SymType &type)
{
    int el;
    if (!(in >> el))
    {
...
public:                                                               // Function declarations
    constexpr int get_nbl() const                                     // Get the number of blocks
    {                                                                 //
        return _nblocks;                                              //
    }                                                                 //
                                                                      //
    constexpr int get_nsteps() const                                  // Get the number of steps in each block
    {                                                                 //
        return _nsteps;                                               //
    }                                                                 //
                                                                      //
